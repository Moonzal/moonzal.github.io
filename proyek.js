...
function updateJadwal() {
  const d = new Date();
  // const d = new Date(2023, 2, 15, 14, 4, 04, 0);
  ...
  if (hari == "Minggu") {
    ...
    if (jam < listMK[4][0].mulai.j) {
      ...
      adaMK(listMK[4][0]);
      hitungMundur(0, listMK[4][1].mulai.j, listMK[4][1].mulai.m);
      jadwalNextK.innerHTML = "Istirahat";
    } else if (listMK[4][0].mulai.j == jam && menit >= listMK[4][0].selesai.m) {
      adaMK(listMK[4][0]);
      hitungMundur(0, listMK[4][1].mulai.j - 1, 100);
      jadwalNextK.innerHTML = "Istirahat";
    } else if (
      ...
      jadwalK.innerHTML = "Istirahat";
      hitungMundur(0, listMK[4][2].mulai.j, listMK[4][2].mulai.m);
      adaMKNext(listMK[4][2]);
    } else if (listMK[4][1].mulai.j < jam && jam < listMK[4][1].selesai.j) {
      jadwalK.innerHTML = "Istirahat";
      hitungMundur(0, listMK[4][2].mulai.j, listMK[4][2].mulai.m);
      adaMKNext(listMK[4][2]);
    } else if (listMK[4][2].mulai.j <= jam && jam < listMK[4][2].selesai.j) {
      adaMK(listMK[4][2]);
      hitungMundur(0, listMK[4][2].selesai.j, listMK[4][2].selesai.m);
      jadwalNextK.innerHTML = "Pulang";
    } else {
      jadwalK.innerHTML = "Pulang";
